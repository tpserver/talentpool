...
Route::get('/', ['as' => 'homepage', function()
{
	...
	$sign_up_url = "http://www.talentpool.com/index.php/sign-up?a=" . $origin_id;
...
/*--------------------------------------------test route-----------------------------------------------------------------------------*/
    Route::get('SuscribeUserController', ['as' => 'SuscribeUserController', 'uses' => 'SuscribeUserController@subscribe_new']);
      Route::get('add_camp', ['as' => 'add_static_segment', 'uses' => 'SuscribeUserController@add_static_segment']);
       Route::get('create_camp', ['as' => 'add_static_segment', 'uses' => 'SuscribeUserController@create_campaign']);
/*-------------------------------------------------------------------------------------------------------------------------*/
...
Route::post('employer/update', ['as' => 'employer.update', 'uses' => 'EmployerController@update']);
...
Route::get('profile/status-on', ['as' => 'profile.profileStatusON', 'uses' => 'UserController@profileStatusON']);
Route::get('profile/status-off', ['as' => 'profile.profileStatusOFF', 'uses' => 'UserController@profileStatusOFF']);
...
Route::get('search/get-subject-names', ['as' => 'search.getSpecificSubjectInput', 'uses' => 'SearchController@getSpecificSubjectInput']);
Route::get('search/get-useremail-names', ['as' => 'search.getUsersEmail', 'uses' => 'SearchController@getUsersEmail']);

Route::post('emailTemplateUpdate', ['as' => 'email-template.update', 'uses' => 'EmailTemplateController@update']);
...
Route::get('payment/status', array(
    'as' => 'payment.status',
    'uses' => 'CampaignController@getPaymentStatus',
));
...
// Admin section and created by SD
Route::resource('admin/dashboard', 'AdminController');
Route::get('admin/dashboard', ['as' => 'admin.dashboard', 'uses' => 'AdminController@index']);
Route::get('admin/userlist', ['as' => 'admin.userList', 'uses' => 'AdminController@usersList']);
Route::get('admin/employeer', ['as' => 'admin.userEmployeerList', 'uses' => 'AdminController@userEmployeerList']);
Route::get('admin/campaigns', ['as' => 'admin.campaigns', 'uses' => 'AdminController@campaignList']);
Route::get('admin/candidatepool', ['as' => 'admin.CandidatePool', 'uses' => 'AdminController@CandidatePoolList']);
Route::get('admin/login', ['as' => 'adminlogin.login', 'uses' => 'AdminLoginControllers@login']);
Route::get('admin/logout', ['as' => 'adminlogout.logout', 'uses' => 'AdminController@logout']);