...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="topbar_bg">
            <div id="topbar">
                ...
                {{link_to_route('signup.empcreate', 'Employer? Click Here!', [], ['class' => 'login-header-btn'])}}
                <div id="spacer"></div>
            </div>
        </div>
        <form id="gl_sign_up" method="post" action="sign-up/submit">
            <div id="basic_form">
                <!--<div><br/>Thanks for dropping by! You can let us know what has changed here - and we have added some new categories as well.<br/><br/>If you have found a job since joining us (either via us or independently, head straight to the 'I'm available for work' section, select 'Other' and click 'I'm not looking to move right now'. You can then stick with us for your are looking for a change but won't be viewable to employers.</div>-->
                ...
                <div id="industry_interest_error" class="error_overlay_header">Sector Preference is required, but this bit's useful to match you with employers.</div>       
                <div id="sector_box">
                    @include('signup.inputs.work', $workOptions)
                    <div id="spacer"></div>
                </div>
                <div id="job_type_box">
                    <div id="industry_type_interest_error" class="error_overlay_header">Job Type is required field. Please choose any one of them.</div>
                    ...
                    <div id="industry_location_interest_error" class="error_overlay_header">Job Location is required field. Please choose any one of them.</div>
                    ...
                    <label class="availability_option">{{Form::radio('availability', 1, true, ['class' => 'radio_availability'])}}Immediately </label>
            ...
            <div id="education_form">
                ...
                <div id="capabilities_container_error" class="error_overlay_header">This bit's required</div>   
                <div id="capabilities_container">
                    ...
                    <div class="checkbox_container_option">
                        <div class="checkbox_option"></div>
                        <p>{{$capability->name}}</p>
                        {{ Form::checkbox('capabilities[]', $capability->id, false) }}
                    </div>
                    @endforeach
                </div>	
            ...
            <div id="experience_form">
                ...
                <div id="key_experience_container">
                    ...
                    <div class="checkbox_container_option"><div class="checkbox_option"></div>
                        <p>{{$experience->name}}</p>
                        {{Form::checkbox('experience[]', $experience->id, false)}}
                    </div>
                    @endforeach
                </div>
                <div id="button_holder">
    ...
    <div id="other_form">
        <div id="charity_error" class="error_overlay_header">Pleae choose atleast one charity option!</div>
        ...
        <div id="attributes_container_error" class="error_overlay_header">Pleae choose atleast one attributes!</div>
        <div id="attributes_container">
            ...
            <div class="checkbox_container_option">
                <div class="checkbox_option"></div>
                <p>{{$attribute->name}}</p>
                {{Form::checkbox('attributes[]', $attribute->id, false)}}
            </div>
            @endforeach
        </div>
        ...
        <div id="other_personal_box">
            ...
            <div id="dob_all_error" class="error_overlay_header">These fields are bit required!</div>
        ...
        <div id="button_holder">
            ...
            {{ Form::button('Sign Up', ['class'=> 'red_button', 'id' => 'next_button_other', 'style' => 'height: 42px;']) }}
        </div>
    </div>
</div>
</form>
