{{ Form::open(['url' => route('opportunity.editeventStore'), 'id' => 'new_opportunity_form'])}}
    <div class="opportunity_basic_info" id="blue_box">
        <div class="text_input_container">
            ...
            {{Form::text('event_title', $opprtunities_avail->name, ['id' => 'event_title', 'placeholder' => 'Event Title'])}}
        </div>
        <div class="text_input_container" style="margin-right: 0">
            ...
            {{Form::text('event_date', $opprtunities_avail->event_start_date, ['id' => 'event_date', 'placeholder' => 'Event Date'])}}
        </div>
        <div class="text_input_container">
            ...
            {{Form::text('rsvp', $opprtunities_avail->rsvp, ['id' => 'rsvp', 'placeholder' => 'RSVP'])}}
        </div>
        <div class="text_input_container" style="margin-right: 0">
            ...
            {{Form::text('close_date', $opprtunities_avail->event_end_date, ['id' => 'close_date', 'placeholder' => 'Close Date'])}}
        </div>
        <div class="text_input_container">
            ...
            {{Form::text('event_location', $opprtunities_avail->event_location, ['id' => 'event_location', 'placeholder' => 'Event Location'])}}
        </div>
        <div class="text_input_container" style="margin-right: 0">
            <div class="error_overlay" id="close_date_error">Event close date required</div>
