...
@section('head.content')
    ...
    function emailTemplateValid()
    {
            ...
            //    alert(flag);
            //    if (flag == 2) {
            //    var tinyeditor=document.getElementById('body').value.length;
            ////   var tinyeditor= document.new_email_form.body.value;
            //    alert(tinyeditor);
            //    //return false;
            //    }
            //    else if (flag == 1) {
            //    var tinyeditor=document.getElementById('code_textarea').value.length;
            //     //var tinyeditor= document.new_email_form.code_textarea.value;
            //     alert(tinyeditor);
            //    }
...
@section('content')
    ...
    @include('common.progress_indicator')
        {{ Form::open(['url' => 'email-template', 'id' => 'new_email_form','name' => 'new_email_form']) }}
    ...
    <div id="new_email_box">
        ...
        <div id="email-template-text-rich" class="text_input_container" style="display:none;">
            <div class="error_overlay" @if(($errors->first('body'))){{'style="display: block;"'}}@endif id="email-template-body-error">Email body required</div>
            {{ Form::textarea('body-rich', Input::old('body-rich'), ['email-template-body' => 'body-html', 'id' =>'code_textarea', 'name' =>'code_textarea']) }}
        </div>        
        @endif
