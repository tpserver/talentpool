...
*/
    ...
    {
        $emailTemplate = EmailTemplate::find($id);
        return View::make('email-templates.email-update')->with('emailTemplate', $emailTemplate);
    }
    ...
    public function update($id)
    {
        ...
        if ($validator->fails())
        {
            return Redirect::to('email-template/edit')->withInput()->withErrors($validator)->with('emailTemplate', $emailTemplate);
        }else
        {
        ...
        return Redirect::to('new-campaign/email');
    }
