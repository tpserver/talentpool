...
class SignupController extends \BaseController {
    ...
    public function subscribe_new($user_email,$marge_vars)
    {
       ...
       $id='7b7bf138c1';//TalentPool subscribed users List id
    ...
    public function submit()
    {
       ...
       // echo 'kk'.$origin_id.'mm';
        ...
        //##################### Temporarily this Mail sending code is closed on 27.02.2015 ###################//
        ...
        //});
         //##################### Temporarily this code is closed on 27.02.2015 ###################//
