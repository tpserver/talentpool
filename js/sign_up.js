...
// == Next Button Basic
    ...
    var industryInterestType = false;
    var industryInterestLocation = false;
    $("#next_button_basic").click(function() {
        ...
        if ($('#sector_box input:checkbox:checked').length == 0) {
            //alert($('#sector_box input:checkbox:checked').length);
        ...
        if($('#job_type_container input:checkbox:checked').length == 0) {
            //alert($('#job_type_container input:checkbox:checked').length);
            //if(!industryInterestType) {
                $("#industry_type_interest_error").fadeIn();
                formError = true;
                industryInterestType = true;
            //}
            //alert(formError);
        }
        ...
        if($('#job_location_container input:checkbox:checked').length == 0) {
            //alert($('#job_type_container input:checkbox:checked').length);
            //if(!industryInterestLocation) {
                $("#industry_location_interest_error").fadeIn();
                formError = true;
                industryInterestLocation = true;
            //}
            //alert(formError);
        }
    ...
    $("#next_button_education").click(function() {
        ...
        if($('#capabilities_container input:checkbox:checked').length == 0) {
            ...
            //if(!capabilitiesError) {
                $("#capabilities_container_error").fadeIn();
                defaultError = true;
...
// == Next Button Other
    $("#next_button_other").click(function() {
        ...
        var charity_select = $('#charity-selection').val();
        if(charity_select == '')
        {
            $('#charity_error').fadeIn();
            defaultError = true;
            errorThrown = true;
        }
        if($('#attributes_container input:checkbox:checked').length == 0) {
            //alert($('#job_type_container input:checkbox:checked').length);
            //if(!capabilitiesError) {
                $("#attributes_container_error").fadeIn();
                defaultError = true;
